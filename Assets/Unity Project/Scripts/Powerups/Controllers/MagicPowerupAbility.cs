...
/// TODO_DESCRIPTION
/// </summary>
[AddComponentMenu("Corgi Engine/Character/Abilities/MagicPowerupAbility")]

public class MagicPowerupAbility : CharacterAbility
{
    /// This method is only used to display a helpbox text
    /// at the beginning of the ability's inspector
    public override string HelpBoxText() { return "The Magic Powerup."; }
    ...
    public Vector2 HitboxDimensions_End = new Vector2(10f, 6f);
    ...
    public TypedDamage MagicDamageReference; // TODO: This feels ugly...

    [SerializeField]
    private float _minDamageCaused = 50f;
    public float MinDamageCaused { get => _minDamageCaused; }
    [SerializeField]
    private float _maxDamageCaused = 50f;
    ...
    protected virtual void DoSomething()
    {
        ...
        MMDebug.DebugLogTime("Starting MagicPowerupAbility!");
        HandleStartAbility();
    }
    ...
    protected virtual void CreateDamageArea()
    {
        ...
        {
            new TypedDamage() // Add Magic Typed Damage
            {
                AssociatedDamageType = MagicDamageReference.AssociatedDamageType,
                MinDamageCaused = 50f,
                MaxDamageCaused = 50f
            }
        };
