...
/// TODO_DESCRIPTION
/// </summary>
[AddComponentMenu("Corgi Engine/Character/Abilities/EarthPowerupAbility")]
public class EarthPowerupAbility : CharacterAbility
{
    /// This method is only used to display a helpbox text
    /// at the beginning of the ability's inspector
    public override string HelpBoxText() { return "The Earth Powerup."; }
    ...
    public TypedDamage EarthDamageReference; // TODO: This feels ugly...

    [SerializeField]
    private float _minDamageCaused = 45f;
    public float MinDamageCaused { get => _minDamageCaused; }
    [SerializeField]
    private float _maxDamageCaused = 45f;
    ...
    protected virtual void DoSomething()
    {
        ...
        MMDebug.DebugLogTime("Starting EarthPowerupAbility!");
        HandleStartAbility();
    }
    ...
    protected virtual void CreateDamageArea()
    {
        ...
        {
            new TypedDamage() // Add Earth Typed Damage
            {
                AssociatedDamageType = EarthDamageReference.AssociatedDamageType,
                MinDamageCaused = 45f,
                MaxDamageCaused = 45f
            }
        };
