...
public class PowerupController : MonoBehaviour
{
    ...
    private WaterPowerupAbility m_WaterPowerupAbility;
    private EarthPowerupAbility m_EarthPowerupAbility;
    private WindPowerupAbility m_WindPowerupAbility;
    private MagicPowerupAbility m_MagicPowerupAbility;
    ...
    private void Start()
    {
        ...
        m_WaterPowerupAbility = GetComponent<WaterPowerupAbility>();
        m_EarthPowerupAbility = GetComponent<EarthPowerupAbility>();
        m_WindPowerupAbility = GetComponent<WindPowerupAbility>();
        m_MagicPowerupAbility = GetComponent<MagicPowerupAbility>();
        TryAddPowerup(Powerup.WATERSPELL);
        TryAddPowerup(Powerup.FIRESPELL);
        TryAddPowerup(Powerup.EARTHSPELL);
        TryAddPowerup(Powerup.WINDSPELL);
        TryAddPowerup(Powerup.MAGICSPELL);
    ...
    public void UsePowerup()
    {
        ...
        switch(m_CurrentPowerup)
        {
            ...
            case Powerup.FIRESPELL:
                ...
                break;
            case Powerup.WATERSPELL:
                m_WaterPowerupAbility.HandleStartAbility();
                break;
            case Powerup.EARTHSPELL:
                m_EarthPowerupAbility.HandleStartAbility();
                break;
            case Powerup.WINDSPELL:
                m_WindPowerupAbility.HandleStartAbility();
                break;
            case Powerup.MAGICSPELL:
                m_MagicPowerupAbility.HandleStartAbility();
                break;
        }
