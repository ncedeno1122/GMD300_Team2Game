...
/// TODO_DESCRIPTION
/// </summary>
[AddComponentMenu("Corgi Engine/Character/Abilities/WaterPowerupAbility")]
public class WaterPowerupAbility : CharacterAbility
{
    /// This method is only used to display a helpbox text
    /// at the beginning of the ability's inspector
    public override string HelpBoxText() { return "The Water Powerup."; }
    ...
    public TypedDamage WaterDamageReference; // TODO: This feels ugly...

    [SerializeField]
    private float _minDamageCaused = 30f;
    public float MinDamageCaused { get => _minDamageCaused; }
    [SerializeField]
    private float _maxDamageCaused = 30f;
    ...
    protected virtual void DoSomething()
    {
        ...
        MMDebug.DebugLogTime("Starting WaterPowerupAbility!");
        HandleStartAbility();
    }
    ...
    protected virtual void CreateDamageArea()
    {
        ...
        {
            new TypedDamage() // Add Water Typed Damage
            {
                AssociatedDamageType = WaterDamageReference.AssociatedDamageType,
                MinDamageCaused = 30f,
                MaxDamageCaused = 30f
            }
        };
