...
/// TODO_DESCRIPTION
/// </summary>
[AddComponentMenu("Corgi Engine/Character/Abilities/WindPowerupAbility")]

public class WindPowerupAbility : CharacterAbility
{
    /// This method is only used to display a helpbox text
    /// at the beginning of the ability's inspector
    public override string HelpBoxText() { return "The Wind Powerup."; }
    ...
    public TypedDamage WindDamageReference; // TODO: This feels ugly...

    [SerializeField]
    private float _minDamageCaused = 10f;
    public float MinDamageCaused { get => _minDamageCaused; }
    [SerializeField]
    private float _maxDamageCaused = 10f;
    ...
    protected virtual void DoSomething()
    {
        ...
        MMDebug.DebugLogTime("Starting WindPowerupAbility!");
        HandleStartAbility();
    }
    ...
    protected virtual void CreateDamageArea()
    {
        ...
        {
            new TypedDamage() // Add Wind Typed Damage
            {
                AssociatedDamageType = WindDamageReference.AssociatedDamageType,
                MinDamageCaused = 10f,
                MaxDamageCaused = 10f
            }
        };
